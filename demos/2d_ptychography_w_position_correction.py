...
params_cameraman = {
    "fname": "data_cameraman_err_10.h5",
    "theta_st": 0,
    "theta_end": 0,
    "theta_downsample": 1,
    "n_epochs": 1000,
    ...
    "probe_type": "supplied",
    "probe_initial": [
        np.squeeze(dxchange.read_tiff("cameraman_pos_error/probe_mag_true.tiff")),
        np.squeeze(dxchange.read_tiff("cameraman_pos_error/probe_phase_true.tiff")),
    ],
