...
dset_new = grp_new.create_dataset(
    "data", shape=[1, n_pos, probe_size[0], probe_size[1]], dtype=dset_old.dtype
)
...
grp_meta_new.create_dataset("energy_ev", data=1240.0 / lmbda_nm)
f_meta.write("wavelength_nm:     {}\n".format(lmbda_nm))
f_meta.write("energy_ev:        {}\n".format(1240.0 / lmbda_nm))
